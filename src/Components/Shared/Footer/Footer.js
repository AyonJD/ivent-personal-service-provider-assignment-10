        ...
        <div>
            ...
            <footer class="bg-gray-800">
                <div class="grid grid-cols-2 gap-8 py-8 px-6 md:grid-cols-4">
                    <div>
                        ...
                        <ul class="text-gray-300">
                            ...
                            <li class="mb-4">
                                <Link to="#" class="hover:underline">Brand Center</Link>
                            </li>
                            <li class="mb-4">
                    ...
                    <div>
                        ...
                        <ul class="text-gray-300">
                            ...
                            <li class="mb-4">
                                <Link to="#" class="hover:underline">Facebook
                                </Link></li><Link to="#" class="hover:underline">
                            </Link><li class="mb-4"><Link to="#" class="hover:underline">
                            </Link><Link to="#" class="hover:underline">Contact Us</Link>
                            </li>
                        </ul>
                    </div>
                    <div>
                ...
                <div class="py-6 px-4 bg-gray-700 md:flex md:items-center md:justify-between">
                    <span class="text-sm text-gray-300 sm:text-center">© 2022 <Link to="https://github.com/AyonJD">Ivent™</Link>. All Rights Reserved.
                    </span>
                    <div class="flex mt-4 space-x-6 sm:justify-center md:mt-0">
                        ...
                        <Link to="https://github.com/AyonJD" class="text-gray-400 hover:text-white">
